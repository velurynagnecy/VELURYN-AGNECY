...
const DEMO_TEMPLATES: Template[] = [
  {
    ...
    body: `Hi [Name],\n\nI came across [Company] and was genuinely impressed by what you're building in [Industry].\n\nWe help companies like yours streamline outreach at scale — I'd love to show you how.\n\nWould you be open to a 15-minute call this week?\n\nBest,\n[Sender]`,
  },
  {
    id: 'follow-up',
    name: 'Follow-Up',
    ...
    body: `Hi [Name],\n\nJust following up on my previous note about [Topic].\n\nI know things get busy — happy to keep it brief. Would a quick call work?\n\nBest,\n[Sender]`,
  },
  {
    id: 'partnership',
    name: 'Partnership Proposal',
    category: 'Networking',
    subject: 'Partnership opportunity — [Company] × VELURYN AGNECY',
    body: `Hi [Name],\n\nI'm reaching out because I believe there's a meaningful alignment between [Company] and VELURYN AGNECY.\n\nWe're both committed to [SharedGoal] — and I think a partnership could create real value for both sides.\n\nWould you be open to an exploratory conversation?\n\nWarm regards,\n[Sender]`,
  },
  {
    id: 'job-offer',
    name: 'Job Offer',
      ...
      {activeTab === 'template' && (
        <div>
          <p className="font-body text-[0.6rem] tracking-[0.25em] uppercase text-silver-dim text-center mb-8">
            {DEMO_TEMPLATES.length} templates in demo &nbsp;·&nbsp; 30+ in Pro
          </p>
          ...
          <div className="text-center mt-10">
            ...
            >
              Continue with &ldquo;{selectedTemplate.name}&rdquo; →
            </button>
          </div>
        </div>
      )}
                ...
                placeholders.map(p => (
                  <div key={p}>
                    ...
                    <input
                      ...
                      placeholder={`Enter ${p}…`}
                      className="form-input w-full bg-charcoal px-4 py-3 font-body text-sm text-platinum placeholder:text-silver-dim/40"
                    />
                  </div>
                ))
              )}
          ...
          <div className="glass-dark border border-border rounded-[24px] overflow-hidden">
            ...
            <div className="p-6">
              ...
              <div className="border-b border-border pb-3 mb-4">
                ...
                <p className="font-body text-platinum text-sm font-medium min-h-[1.25rem]">
                  {previewSubject || <span className="text-silver-dim/40 italic font-normal">Preview will appear here…</span>}
                </p>
              </div>
              <div className="font-body text-silver text-sm leading-relaxed whitespace-pre-wrap max-h-72 overflow-y-auto min-h-[4rem]">
            ...
            <>
              ...
              <div className="flex flex-wrap items-center gap-4 mt-8 pt-8 border-t border-border">
                ...
                <div className="ml-auto glass border border-border rounded-[16px] px-5 py-3 flex items-center gap-4">
                  <div>
                    <p className="font-body text-[0.6rem] tracking-[0.15em] uppercase text-silver-dim mb-0.5">Want to send 1,000+ at once?</p>
                    <p className="font-body text-platinum text-xs">Upload a CSV and generate bulk personalised emails with Pro.</p>
                  </div>
                  <a
                    href="/contact"
