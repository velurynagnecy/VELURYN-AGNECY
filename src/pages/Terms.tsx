      ...
      <section style={{ padding: '4rem 4rem', maxWidth: '900px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', fontFamily: 'var(--font-body)', color: '#444', lineHeight: 1.6 }}>
          ...
          <div>
            ...
            <p>VELURYN AGNECY ("the Agency") acts as a brokerage connecting consumer mobile applications ("Brands") with User-Generated Content creators ("Creators"). By engaging our services, both Brands and Creators agree to adhere to the workflow and payment terms outlined herein.</p>
          </div>
